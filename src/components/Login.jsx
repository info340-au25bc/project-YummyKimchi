        ...
        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="login-box flex-column">
            ...
            <form>
                <div className="flex-column subsection">
                    ...
                    <div className="flex-column submission-box"><motion.button initial={{ scale: 0 }} animate={{ scale: 1 }} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }} type="button" onClick={handleClick}>Submit</motion.button></div>
                </div>
            </form>
